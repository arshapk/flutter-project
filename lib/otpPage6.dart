...
class OtpVerificationPg6 extends StatefulWidget {
  @override
  _OtpVerificationPg6State createState() => _OtpVerificationPg6State();
}

class _OtpVerificationPg6State extends State<OtpVerificationPg6> {
